            ...
            >
              ...
              >
                <View style={styles.skinGradientBlock}>
                  ...
                  <View style={[styles.skinGradientQuarter, { backgroundColor: assetDarkMode ? "#2563eb" : "#93c5fd" }]} />
                  <View style={[styles.skinGradientQuarter, { backgroundColor: assetDarkMode ? "#f87171" : "#fbbf24" }]} />
                  <View style={[styles.skinGradientQuarter, { backgroundColor: assetDarkMode ? "#34d399" : "#1e3a5f" }]} />
                </View>
              </Pressable>
            </View>
          </View>
